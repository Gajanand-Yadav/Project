...
import InfiniteScroll from "../Features/infinitescroll.jsx";
  const KrishiSahayak = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver((entries) => {
        if(entries[0].isIntersecting) {
            setVisibleSchemes((prev) => Math.min(prev + 5,Schemes.length));
        }; 
        { threshold: 1 }
    });
    if(loadMoreRef.current){
        observer.observer(loadMoreRef.current);
    }
    return()=> {
        if(loadMoreRef.current)
...
useEffect(() => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Upload photos of affected crops and get instant diagnosis with treatment recommendations.",
    },
    {
      icon: "cloud",
    ...
    },
    {
      ...
      description:
        "Monitor all farm expenses and income in one place with insightful analytics.",
    },
    {
      icon: "file-text",
      title: "Government Schemes Info",
      description:
        "Stay updated with all agricultural schemes and subsidies you're eligible for.",
    },
  ];
      ...
      <nav className="navigation">
        <div className="container navigation-container">
          ...
          <div className="nav-links">
            ...
            <button onClick={(e) => openSignIn()} className="btn-login">
              Register
            </button>
          </div>
              ...
              {schemes.map((scheme, index) => (
                ...
                >
                  ...
                  <button className="scheme-learn-more">
                    Learn more{" "}
                    <i data-feather="arrow-right" className="arrow-icon"></i>
                  </button>
                </div>
              ))}
              {isLoading && (
      ...
      <footer className="footer">
        ...
        <div className="footer-bottom">
          <p className="copyright">
            © 2023 Krishi Sahayak. All rights reserved.
          </p>
